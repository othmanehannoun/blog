                        ...
                        <div class="col-lg-8 col-md-12">
                            <div class="post-card">
                                <div class="post-image">
                                    <img class="img-fluid" src="images/blog/blog5.jpg" alt="" style="width: 100%;">
                                </div>
                                <div class="post-desc">
                                    <div class="post-meta">
                                   ...
                                   <br></br>
                                    <h3 class="postbox-feature-title">1. ABL: Always Be Learning</h3>
                                    <p class="mb-0">
                                   ...
                                   <br></br>
                                    <h3 class="postbox-feature-title">2. Develop Top Level Time Management Skills</h3>
                                    <p class="mb-0">
                                   ...
                                   <br></br>
                                    <h3 class="postbox-feature-title">3. Learn How To Network Effectively</h3>
                                    <p class="mb-0">
                                   ...
                                   <br></br>
                                    <h3 class="postbox-feature-title">4. Develop Critical Thinking Skills</h3>
                                    <p class="mb-0">
                                   ...
                                   <br></br>
                                    <h3 class="postbox-feature-title">5. Hone Your People Skills</h3>
                                    <p class="mb-0">
                                   ...
                                   <br></br>
                                    <h3 class="postbox-feature-title">6. Stay Alert for New Marketing Techniques for Reaching Customers</h3>
                                    <p class="mb-0">
                                   ...
                                   <br></br>
                                    <h3 class="postbox-feature-title">7. Develop Healthy Habits For Yourself and Those Around You</h3>
                                    <p class="mb-0">
                                   ...
                                   <br></br>
                                    <h3 class="postbox-feature-title">Conclusion</h3>
                                    <p class="mb-0">
